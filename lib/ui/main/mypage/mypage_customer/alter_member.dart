            ...
            actions: [
              TextButton(
                onPressed: () async {
                  ...
                  await viewModel.updateMemberFetch(
                    nickName,
                    profileImagePath ?? '',
                  );
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: GestureDetector(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(' 사진 올리기', style: context.bodyBold),
                        ],
                      ),
                    ),
                  ),
                ...
                gap48,
                Text("이메일", style: context.bodyBold),
                gap4,
                Padding(
                  padding: EdgeInsets.only(left: 12),
                  child: Text(member?.email ?? '', style: context.bodyBold),
                ),
                gap24,
                Text("닉네임", style: context.bodyBold),
                gap8,
